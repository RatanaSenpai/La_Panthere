    ...
    var C, O, t, o, a = function(e, t) {
        ...
        p = (C = document, O = function(o) {
            ...
            this.map = new google.maps.Map(this.el, y), a && (this.markerClusterer = a.apply(this, [this.map])), this.buildContextMenu = function(o, n) {
                ...
                var t, o, n = C.createElement("ul");
                for (t in e.options) e.options.hasOwnProperty(t) && (o = e.options[t], window.context_menu[h.el.id][e.control][o.name] = {
                    title: o.title,
                    action: o.action
                });
                n.id = "gmaps_context_menu", n.style.display = "none", n.style.position = "absolute", n.style.minWidth = "100px", n.style.background = "white", n.style.listStyle = "none", n.style.padding = "8px", n.style.boxShadow = "2px 2px 6px #ccc", x("gmaps_context_menu") || C.body.appendChild(n);
            ...
            for (e = 0; e < _.length; e++) ! function(e, t, o) {
                e[o] = function() {
                    return t[o].apply(t, arguments)
                }
            }(this, this.map, _[e])
        });
    return p.prototype.createControl = function(t) {
        var e, o, n = document.createElement("div");
        for (e in n.style.cursor = "pointer", !0 !== t.disableDefaultStyles && (n.style.fontFamily = "Roboto, Arial, sans-serif", n.style.fontSize = "11px", n.style.boxShadow = "rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px"), t.style) n.style[e] = t.style[e];
        for (o in t.id && (n.id = t.id), t.title && (n.title = t.title), t.classes && (n.className = t.classes), t.content && ("string" == typeof t.content ? n.innerHTML = t.content : t.content instanceof HTMLElement && n.appendChild(t.content)), t.position && (n.position = google.maps.ControlPosition[t.position.toUpperCase()]), t.events) ! function(e) {
        ...
        if (void 0 === e) {
            ...
            for (o = 0; o < e.length; o++) {
                var n = this.markers.indexOf(e[o]); - 1 < n && ((i = this.markers[n]).setMap(null), this.markerClusterer && this.markerClusterer.removeMarker(i), p.fire("marker_removed", i, this))
            }
        ...
        for (var e = new google.maps.Circle(o), t = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], n = 0; n < t.length; n++) ! function(t) {
        ...
        o.bounds = e;
        for (var n = new google.maps.Rectangle(o), t = ["click", "dblclick", "mousedown", "mousemove", "mouseout", "mouseover", "mouseup", "rightclick"], i = 0; i < t.length; i++) ! function(t) {
        ...
        var o = e.events;
        delete e.events;
        var t, n = new google.maps.FusionTablesLayer(e);
        ...
        var n, i = new google.maps.KmlLayer(t, e);
        for (n in o) ! function(t) {
        ...
        switch (t = t || {}, e) {
            ...
            case "panoramio":
                ...
                break;
            case "places":
                this.singleLayers.places = o = new google.maps.places.PlacesService(this.map), (t.search || t.nearbySearch || t.radarSearch) && (n = {
                    ...
                    types: t.types || null
                }, t.radarSearch && o.radarSearch(n, t.radarSearch), t.search && o.search(n, t.search), t.nearbySearch && o.nearbySearch(n, t.nearbySearch)), t.textSearch && (n = {
                    bounds: t.bounds || null,
                    location: t.location || null,
                    query: t.query || null,
                    radius: t.radius || null
        ...
        })) : (delete e.path, delete e.samples, n.getElevationForLocations(e, function(e, t) {
            o && "function" == typeof o && o(e, t)
        }))
        ...
        if (0 < this.step_count) {
            this.step_count--;
            var e, t = this.route.legs[0].steps[this.step_count].path;
        ...
        return 0 < this.polylines.length && (e = this.polylines[0], t.polyline = {}, t.polyline.path = google.maps.geometry.encoding.encodePath(e.getPath()), t.polyline.strokeColor = e.strokeColor, t.polyline.strokeOpacity = e.strokeOpacity, t.polyline.strokeWeight = e.strokeWeight), p.staticMapURL(t)
        ...
        if (-1 == p.custom_events.indexOf(e)) google.maps.event.trigger(t, e, Array.prototype.slice.apply(arguments).slice(2));
            ...
            for (var n = o.registered_events[e], i = 0; i < n.length; i++) n[i].handler.apply(o, [t])
